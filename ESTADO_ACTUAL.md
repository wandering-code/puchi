...
## Notas de despliegue (producción, Mac mini — pendiente)

- Build estático de Vite servido por Nginx
- FastAPI como servicio con systemd, puerto 8001
- Nuevo `server_name` en Nginx para el subdominio de Puchi, SSL con Certbot
- BD comparte instancia PostgreSQL existente, tablas propias
